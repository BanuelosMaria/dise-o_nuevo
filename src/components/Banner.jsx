    ...
    <Carousel className="App-banner">
      ...
      <Carousel.Item>
        ...
        <Carousel.Caption>
          <h3>ReactJs</h3>
          <p>
            React JS es una librería de código abierto de JavaScript para crear
            interfaces de usuario reutilizables, interactivas.
          </p>
        </Carousel.Caption>
      </Carousel.Item>
      <Carousel.Item>
        ...
        <Carousel.Caption>
          <h3>Github</h3>
          <p>
            Github es un portal creado para alojar el código de las aplicaciones
            de cualquier desarrollador, y que fue comprada por Microsoft en
            junio del 2018.
          </p>
        </Carousel.Caption>
      </Carousel.Item>
